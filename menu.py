...
import os
import json
from pygame.locals import QUIT, KEYDOWN, KEYUP, K_ESCAPE, K_RETURN, K_UP, K_DOWN, K_DELETE
...
class MenuSystem:
    ...
    def draw_world_select_menu(self):
        ...
        create_rect = create_text.get_rect(center=(WINDOW_SIZE[0] // 2, start_y + len(worlds) * 50))
        ...
        for i, instruction in enumerate(instructions):
            ...
            text_rect = text.get_rect(center=(WINDOW_SIZE[0] // 2, WINDOW_SIZE[1] - 120 + i * 30))
            self.screen.blit(text, text_rect)
